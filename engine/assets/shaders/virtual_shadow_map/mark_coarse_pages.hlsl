...
void cs_main(uint3 dtid : SV_DispatchThreadID)
{
    ...
    if (vsm.cascade_index >= DIRECTIONAL_VSM_CASCADE_COUNT - DIRECTIONAL_VSM_CASCADE_COARSE_OFFSET)
    {
        return;
    }
    ...
    float2 virtual_page_coord = (position_ls.xy * 0.5 + 0.5) * VIRTUAL_PAGE_TABLE_SIZE - 0.5;

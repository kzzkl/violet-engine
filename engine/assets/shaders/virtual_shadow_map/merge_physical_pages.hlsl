...
struct constant_data
{
    ...
    uint physical_shadow_map_static;
    uint physical_shadow_map_final;
};
...
void cs_main(uint3 dtid : SV_DispatchThreadID)
{
    ...
    Texture2D<uint> physical_shadow_map_static = ResourceDescriptorHeap[constant.physical_shadow_map_static];
    RWTexture2D<uint> physical_shadow_map_final = ResourceDescriptorHeap[constant.physical_shadow_map_final];

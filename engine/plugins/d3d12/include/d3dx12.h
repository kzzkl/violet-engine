...
struct CD3DX12_RANGE_UINT64 : public D3D12_RANGE_UINT64
{
    ...
    explicit CD3DX12_RANGE_UINT64(const D3D12_RANGE_UINT64& o) : D3D12_RANGE_UINT64(o) {}
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
    ...
    {
        handle.ptr =
            SIZE_T(INT64(base.ptr) + INT64(offsetInDescriptors) * INT64(descriptorIncrementSize));
    }
};
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
    ...
    {
        handle.ptr =
            UINT64(INT64(base.ptr) + INT64(offsetInDescriptors) * INT64(descriptorIncrementSize));
    }
};
...
inline void D3D12DecomposeSubresource(
    UINT Subresource,
    UINT MipLevels,
    UINT ArraySize,
    _Out_ T& MipSlice,
    ...
    _In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA* pSrcData)
{
    ...
    UINT64 MemToAlloc =
        static_cast<UINT64>(
            sizeof(D3D12_PLACED_SUBRESOURCE_FOOTPRINT) + sizeof(UINT) + sizeof(UINT64)) *
        NumSubresources;
...
struct CD3DX12_RT_FORMAT_ARRAY : public D3D12_RT_FORMAT_ARRAY
{
    ...
    explicit CD3DX12_RT_FORMAT_ARRAY(const D3D12_RT_FORMAT_ARRAY& o) : D3D12_RT_FORMAT_ARRAY(o) {}
...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER() noexcept : SeenDSS(false)
    {
        ...
        static_cast<D3D12_DEPTH_STENCIL_DESC1&>(PipelineStream.DepthStencilState).DepthEnable =
            false;
    }
         ...
         CurOffset += SizeOfSubobject)
    {
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_ROOT_SIGNATURE:
            pCallbacks->RootSignatureCb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM::pRootSignature)*>(
                    pStream));
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER:
            pCallbacks->RasterizerStateCb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM::RasterizerState)*>(
                    pStream));
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL1:
            pCallbacks->DepthStencilState1Cb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM::DepthStencilState)*>(
                    pStream));
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_IB_STRIP_CUT_VALUE:
            pCallbacks->IBStripCutValueCb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM::IBStripCutValue)*>(
                    pStream));
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VIEW_INSTANCING:
            pCallbacks->ViewInstancingCb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM1::ViewInstancingDesc)*>(
                    pStream));
...
inline bool operator==(
    const D3D12_RENDER_PASS_BEGINNING_ACCESS& a,
...
inline bool operator==(
    const D3D12_RENDER_PASS_ENDING_ACCESS& a,
...
inline bool operator==(
    const D3D12_RENDER_PASS_RENDER_TARGET_DESC& a,
...
inline bool operator==(
    const D3D12_RENDER_PASS_DEPTH_STENCIL_DESC& a,

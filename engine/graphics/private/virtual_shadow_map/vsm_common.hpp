...
static constexpr float VSM_CLIPMAP_CASCADE_0_RADIUS = 2.56f;
static constexpr float VSM_CLIPMAP_CASCADE_0_TEXEL_SIZE =
    VSM_CLIPMAP_CASCADE_0_RADIUS * 2.0f / VSM_VIRTUAL_RESOLUTION;
} // namespace violet
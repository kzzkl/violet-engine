...
class mmd_material : public material_instance<mmd_material_constant>
{
public:
    mmd_material();
...
class mmd_outline_material : public material_instance<mmd_outline_material_constant>
{
public:
...
class toon_shading_model : public shading_model
{
public:
    toon_shading_model();
};

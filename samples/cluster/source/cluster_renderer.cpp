...
namespace violet
{
cluster_renderer::cluster_renderer()
{
...
void cluster_renderer::on_render(render_graph& graph)
{
...
void cluster_renderer::add_cull_pass(render_graph& graph)
{
...
void cluster_renderer::add_gbuffer_pass(render_graph& graph)
{
...
void cluster_renderer::add_hzb_pass(render_graph& graph)
{
...
void cluster_renderer::add_gtao_pass(render_graph& graph)
{
...
void cluster_renderer::add_shading_pass(render_graph& graph)
{
...
void cluster_renderer::add_motion_vector_pass(render_graph& graph)
{
...
void cluster_renderer::add_taa_pass(render_graph& graph)
{
...
void cluster_renderer::add_tone_mapping_pass(render_graph& graph)
{
...
void cluster_renderer::add_present_pass(render_graph& graph)
{

...
page::page(std::string_view title)
{
    ...
    layout()->set_padding(40.0f, ui::LAYOUT_EDGE_ALL);
    layout()->set_flex_direction(ui::LAYOUT_FLEX_DIRECTION_COLUMN);

    m_title = std::make_unique<ui::label>(title, ui.theme<ui::label_theme>("gallery title 1"));
    m_title->layout()->set_margin(20, ui::LAYOUT_EDGE_TOP);
    m_title->layout()->set_margin(10, ui::LAYOUT_EDGE_BOTTOM);
    add(m_title.get());
}
...
void page::add_subtitle(std::string_view subtitle)
{
    ...
    subtitle_label->layout()->set_margin(10, ui::LAYOUT_EDGE_TOP);
    subtitle_label->layout()->set_margin(5, ui::LAYOUT_EDGE_BOTTOM);
...
void page::add_description(std::string_view description)
{
    ...
    description_label->layout()->set_margin(5, ui::LAYOUT_EDGE_TOP);
    description_label->layout()->set_margin(5, ui::LAYOUT_EDGE_BOTTOM);
...
ui::panel* page::add_display_panel()
{
    ...
    display_panel->layout()->set_padding(20.0f, ui::LAYOUT_EDGE_ALL);
    display_panel->layout()->set_margin(20.0f, ui::LAYOUT_EDGE_TOP);
    display_panel->layout()->set_margin(20.0f, ui::LAYOUT_EDGE_BOTTOM);
